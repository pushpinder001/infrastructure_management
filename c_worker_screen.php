...
<div class="row">
      <div class="col s6">
        <p><a href="c_worker_screen.php" class="breadcrumb"><i class="material-icons">home</i>&nbsp;Home</a></p>
      </div>
...
<div class="container">
 <div class="row">
 <a href="c_worker_complaint_status.php">
 ...
 <a href="c_worker_update_complaint.php">
 <div class="col s4 myBox" align="center">
 <div class="collapsible collapsible-header myBox"><font style="font-size:1.5em; color:#000000">Update Complaint Status</font></div>
 </div>
 </a>
 </div>
</div>
