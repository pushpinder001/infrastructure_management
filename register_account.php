...
<div class="row">
      <div class="col s6">
        ...
        <a href="register_account.php">Register Account</a></p>
      </div>
...
<br/><br/>
<div class="container">
<h3 align="center"><span class="white-text">Register Account</span></h3>
</div>
<br/><br/><br/>
 <div class="container">
 <div class="row">
    ...
    <form class="col s12" action="register.php" method="post">
     ...
     ?></p></div>
      <div class="row" style="padding:10px">
        ...
        <div class="input-field col s6">
          <input id="roll_number" type="text" class="validate" name="roll_number">
      ...
      <div class="row" style="padding:10px">
          ...
          <input id="room_number" type="number" class="validate" name="room_number">
