...
<div class="row">
      <div class="col s6">
        ...
        <a href="cancel_complaint_student.php">Cancel Complaint</a></p>
      </div>
...
<br/><br/>
<div class="container">
<h3 align="center"><span class="white-text">Cancel Complaints</span></h3>
</div>
<br/>
    <div class="row">
...
<table>
	...
	while($row = mysqli_fetch_assoc($data)):
		...
		echo '</td>';
		echo '<td>' ?>
		<form method="post" action="check_cancel_complaint_student.php"> 
