...
<div class="row">
      <div class="col s6">
        ...
        <a href="cancel_order.php">Cancel Order</a></p>
      </div>
...
<br/><br/>
<div class="container">
<h3 align="center"><span class="white-text">Cancel Order</span></h3>
</div>
...
<table>
	...
	while($row = mysqli_fetch_assoc($data)):
		if(strcmp("Completed",$row['status'])==0)
		{
			continue;
		}
		echo '<tr>';
		...
		echo '</td>';
		echo '<td>' ?>
		<form method="post" action="check_cancel_order.php"> 
